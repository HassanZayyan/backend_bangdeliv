...
class ApiRouteContractTest extends TestCase
{
    ...
    public static function flutterRouteContracts(): array
    {
        return [
            ...
            'shopping merchant replacement preview' => ['api.v1.orders.shopping-stops.replacement.preview', 'POST', 'api/v1/orders/{orderId}/shopping-stops/{pickupLocationId}/replacement-preview'],
            'shopping merchant replacement' => ['api.v1.orders.shopping-stops.replacement.store', 'POST', 'api/v1/orders/{orderId}/shopping-stops/{pickupLocationId}/replace'],
            ...
            'driver shopping unavailable items bypass' => ['api.v1.driver.orders.shopping-stops.unavailable-items.bypass', 'POST', 'api/v1/driver/orders/{orderId}/shopping-stops/{pickupLocationId}/unavailable-items/bypass'],
            'driver shopping unavailable items replace' => ['api.v1.driver.orders.shopping-stops.unavailable-items.replace', 'POST', 'api/v1/driver/orders/{orderId}/shopping-stops/{pickupLocationId}/unavailable-items/replace'],
            'driver shopping unavailable items decision' => ['api.v1.driver.orders.shopping-stops.unavailable-items.decision', 'POST', 'api/v1/driver/orders/{orderId}/shopping-stops/{pickupLocationId}/unavailable-items/decision'],
            'driver shopping merchant replacement preview' => ['api.v1.driver.orders.shopping-stops.replacement.preview', 'POST', 'api/v1/driver/orders/{orderId}/shopping-stops/{pickupLocationId}/replacement-preview'],
            'driver shopping merchant replacement' => ['api.v1.driver.orders.shopping-stops.replacement.store', 'POST', 'api/v1/driver/orders/{orderId}/shopping-stops/{pickupLocationId}/replace'],
