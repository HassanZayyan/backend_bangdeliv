...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'role:driver'])->group(function () {
        ...
        Route::middleware('driver.active')->group(function () {
            ...
            Route::post('/driver/orders/{orderId}/shopping-stops/{pickupLocationId}/replacement-approval/approve', [OrderController::class, 'approveShoppingMerchantReplacementByDriver'])->name('api.v1.driver.orders.shopping-stops.replacement-approval.approve');
            Route::post('/driver/orders/{orderId}/shopping-stops/{pickupLocationId}/replacement-approval/reject', [OrderController::class, 'rejectShoppingMerchantReplacementByDriver'])->name('api.v1.driver.orders.shopping-stops.replacement-approval.reject');
