...
<div class="panel">
    ...
    <form action="{{ route('admin.restaurants.store') }}" method="POST" style="padding: 24px;">
        @csrf
        ...
        <div style="margin-bottom: 24px;">
            ...
            <div style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:16px;">
                ...
                <div class="form-group" style="margin-bottom:0;">
                    ...
                    <input type="number" min="1" max="240" name="estimated_prep_time" value="{{ old('estimated_prep_time', 15) }}" class="form-control" required>
                ...
                <div class="form-group" style="margin-bottom:0; grid-column: span 2;">
                    ...
                    <textarea name="description" rows="3" class="form-control" placeholder="Ceritakan sedikit tentang restoran ini...">{{ old('description') }}</textarea>
